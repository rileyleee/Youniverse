package com.ssafy.youniverse.security.oauth2.service;
...
import com.ssafy.youniverse.security.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    /**
     * SocialType과 attributes에 들어있는 소셜 로그인의 이메일값을 통해 회원을 찾아 반환하는 메소드
