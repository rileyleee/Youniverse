<div align="center">
    ...
    <h2>✨Youniverse✨</h2>
    <p>사용자의 유튜브 취향을 반영한 최적의 OTT, 영화 추천 서비스스</p>
    <hr>
</div>
...
한줄 소개 : 사용자의 유튜브 취향을 반영한 최적의 OTT, 영화 추천 서비스스
</br>
...
### 3. 아토믹 디자인 패턴 도입
#### 아토믹 디자인 패턴이란?
- 코드의 재사용성 및 유지보수성을 높이기 위해 화면의 컴포넌트를 잘게 쪼개 가장 작은 단위인 원자로 설정하고 이를 바탕으로 상위 컴포넌트를 만들어 화면을 구현하는 방법론
- 'Youniverse에서는 atoms(원자), organism(유기체), pages의 컴포넌트로 단계를 세분화하고 구현에 활용했습니다.
---
